sap.ui.define([
		...
		return BaseObject.extend("manh.model.ListSelector", {
			 ...
			 * @return {manh.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
